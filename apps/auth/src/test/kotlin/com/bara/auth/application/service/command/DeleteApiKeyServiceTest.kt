...
class DeleteApiKeyServiceTest {
    ...
    private val service = DeleteApiKeyService(providerRepository, apiKeyRepository)
    ...
    fun `Provider가 없으면 ProviderNotFoundException`() {
        ...
        assertThrows<ProviderNotFoundException> { service.delete("u-1", "k-1") }
    }
    ...
    fun `API Key가 없으면 ApiKeyNotFoundException`() {
        ...
        assertThrows<ApiKeyNotFoundException> { service.delete("u-1", "k-1") }
    }
