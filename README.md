...
| 문서 | 내용 |
|------|------|
| [00-overview](docs/spec/00-overview.md) | 전체 아키텍처, 구성 요소, 기술 스택 |
| [01-infrastructure](docs/spec/01-infrastructure.md) | VM, K3s, Cloudflare, Nginx, 네트워크 |
| [02-authentication](docs/spec/02-authentication.md) | Google OAuth, JWT, Provider 토큰, Kafka 토큰 |
| [03-agent-registry](docs/spec/03-agent-registry.md) | Agent 등록, Redis, Agent Card, 태스크 처리 |
| [04-messaging](docs/spec/04-messaging.md) | Kafka 통신, SSE, 에러, 스케줄, 태스크 수명 |
| [05-security](docs/spec/05-security.md) | 위협 매트릭스, 계층별 대응, 우선순위 로드맵 |
| [06-logging](docs/spec/06-logging.md) | 로그 파이프라인, Grafana, 알람 |
| [07-clients](docs/spec/07-clients.md) | 웹 FE, 텔레그램, 멀티턴 대화 |
| [08-scheduler](docs/spec/08-scheduler.md) | 스케줄 등록/실행, Webhook, Scheduler Service |
| [decisions/](docs/spec/decisions/) | Architecture Decision Records (ADR-001 ~ ADR-011) |
