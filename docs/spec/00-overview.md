...
| 문서 | 내용 |
|------|------|
| [01-infrastructure.md](01-infrastructure.md) | VM, K3s, Cloudflare, 도메인, Pod 구성 |
| [02-authentication.md](02-authentication.md) | Google OAuth, JWT, Provider 토큰, Kafka 토큰 |
| [03-agent-registry.md](03-agent-registry.md) | Redis TTL, API Service, Agent Card, heartbeat |
| [04-messaging.md](04-messaging.md) | Kafka 기반 통신, 토픽 설계, OAUTHBEARER |
| [05-security.md](05-security.md) | 위협 매트릭스, 대응, 헤더 보안, ACL |
| [06-logging.md](06-logging.md) | Fluent Bit, Loki, Grafana, X-Request-Id 추적 |
| [07-clients.md](07-clients.md) | FE, Telegram Service, 멀티턴 대화 |
| [08-scheduler.md](08-scheduler.md) | 스케줄 등록/실행, Webhook, Scheduler Service |
